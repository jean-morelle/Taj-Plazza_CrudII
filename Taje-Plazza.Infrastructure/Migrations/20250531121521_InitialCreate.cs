        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceDEquipements_Equipements_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Espaces_SpaceId",
                        column: x => x.SpaceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evenements_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factures_Espaces_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Espaces",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LocationDEquipements_Equipements_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationDEquipements_Evenements_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evenements_ReservationId",
                table: "Evenements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Factures_SpaceId",
                table: "Factures",
                column: "SpaceId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationDEquipements_EquipmentId",
                table: "LocationDEquipements",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationDEquipements_EventId",
                table: "LocationDEquipements",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceDEquipements_EquipmentId",
